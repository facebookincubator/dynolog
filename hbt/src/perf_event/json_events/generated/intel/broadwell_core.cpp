...
Note: Only two data-sources of L1/FB are applicable for AVX-256bit  even though the corresponding AVX load could be serviced by a deeper level in the memory hierarchy. Data source is reported for the Low-half load.)",
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0001}},
      R"(Counts demand data reads)",
      R"(Counts demand data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0002}},
      R"(Counts all demand data writes (RFOs))",
      R"(Counts all demand data writes (RFOs))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0004}},
      R"(Counts all demand code reads)",
      R"(Counts all demand code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts writebacks (modified to exclusive) have any response type.)",
      R"(Counts writebacks (modified to exclusive) have any response type.)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x80020008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x100020008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x200020008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x400020008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1000020008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2000020008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F80020008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x803C0008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1003C0008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2003C0008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x4003C0008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x10003C0008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F803C0008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x84000008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x104000008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x204000008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x404000008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1004000008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2004000008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F84000008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0xBC000008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x13C000008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x23C000008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x43C000008}},
      R"(Counts writebacks (modified to exclusive))",
      R"(Counts writebacks (modified to exclusive))",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2000020010}},
      R"(Counts prefetch (that bring data to L2) data reads)",
      R"(Counts prefetch (that bring data to L2) data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0010}},
      R"(Counts prefetch (that bring data to L2) data reads)",
      R"(Counts prefetch (that bring data to L2) data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2004000010}},
      R"(Counts prefetch (that bring data to L2) data reads)",
      R"(Counts prefetch (that bring data to L2) data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0020}},
      R"(Counts all prefetch (that bring data to L2) RFOs)",
      R"(Counts all prefetch (that bring data to L2) RFOs)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2004000020}},
      R"(Counts all prefetch (that bring data to L2) RFOs)",
      R"(Counts all prefetch (that bring data to L2) RFOs)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts all prefetch (that bring data to LLC only) code reads have any response type.)",
      R"(Counts all prefetch (that bring data to LLC only) code reads have any response type.)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x80020040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x100020040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x200020040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x400020040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1000020040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2000020040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F80020040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x803C0040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F803C0040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x84000040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x104000040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x204000040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x404000040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1004000040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2004000040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F84000040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0xBC000040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x13C000040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x23C000040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x43C000040}},
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      R"(Counts all prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0080}},
      R"(Counts all prefetch (that bring data to LLC only) data reads)",
      R"(Counts all prefetch (that bring data to LLC only) data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2004000080}},
      R"(Counts all prefetch (that bring data to LLC only) data reads)",
      R"(Counts all prefetch (that bring data to LLC only) data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2000020100}},
      R"(Counts all prefetch (that bring data to LLC only) RFOs)",
      R"(Counts all prefetch (that bring data to LLC only) RFOs)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0100}},
      R"(Counts all prefetch (that bring data to LLC only) RFOs)",
      R"(Counts all prefetch (that bring data to LLC only) RFOs)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2004000100}},
      R"(Counts all prefetch (that bring data to LLC only) RFOs)",
      R"(Counts all prefetch (that bring data to LLC only) RFOs)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x10200}},
      R"(Counts prefetch (that bring data to LLC only) code reads have any response type.)",
      R"(Counts prefetch (that bring data to LLC only) code reads have any response type.)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x80020200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x100020200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x200020200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x400020200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1000020200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2000020200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F80020200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x803C0200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1003C0200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2003C0200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x4003C0200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x10003C0200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F803C0200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x84000200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x104000200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x204000200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x404000200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1004000200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2004000200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F84000200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0xBC000200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x13C000200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x23C000200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x43C000200}},
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      R"(Counts prefetch (that bring data to LLC only) code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C8000}},
      R"(Counts any other requests)",
      R"(Counts any other requests)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x10090}},
      R"(Counts all prefetch data reads have any response type.)",
      R"(Counts all prefetch data reads have any response type.)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x80020090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x100020090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x200020090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x400020090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1000020090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2000020090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F80020090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x803C0090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1003C0090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2003C0090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x4003C0090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x10003C0090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F803C0090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x84000090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x104000090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x204000090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x404000090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1004000090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2004000090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F84000090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0xBC000090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x13C000090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x23C000090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x43C000090}},
      R"(Counts all prefetch data reads)",
      R"(Counts all prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts prefetch RFOs have any response type.)",
      R"(Counts prefetch RFOs have any response type.)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2000020120}},
      R"(Counts prefetch RFOs)",
      R"(Counts prefetch RFOs)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0120}},
      R"(Counts prefetch RFOs)",
      R"(Counts prefetch RFOs)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2004000120}},
      R"(Counts prefetch RFOs)",
      R"(Counts prefetch RFOs)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x10240}},
      R"(Counts all prefetch code reads have any response type.)",
      R"(Counts all prefetch code reads have any response type.)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x80020240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x100020240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x200020240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x400020240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1000020240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2000020240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F80020240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x803C0240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1003C0240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2003C0240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x4003C0240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x10003C0240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F803C0240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x84000240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x104000240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x204000240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x404000240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1004000240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2004000240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F84000240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0xBC000240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x13C000240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x23C000240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x43C000240}},
      R"(Counts all prefetch code reads)",
      R"(Counts all prefetch code reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x10091}},
      R"(Counts all demand & prefetch data reads have any response type.)",
      R"(Counts all demand & prefetch data reads have any response type.)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x80020091}},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x100020091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x200020091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x400020091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1000020091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2000020091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F80020091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x803C0091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2003C0091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x84000091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x104000091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x204000091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x404000091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x1004000091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2004000091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x3F84000091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0xBC000091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x13C000091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x23C000091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x43C000091}},
      R"(Counts all demand & prefetch data reads)",
      R"(Counts all demand & prefetch data reads)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts all demand & prefetch RFOs have any response type.)",
      R"(Counts all demand & prefetch RFOs have any response type.)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts all demand & prefetch RFOs)",
      R"(Counts all demand & prefetch RFOs)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2000020122}},
      R"(Counts all demand & prefetch RFOs)",
      R"(Counts all demand & prefetch RFOs)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x20003C0122}},
      R"(Counts all demand & prefetch RFOs)",
      R"(Counts all demand & prefetch RFOs)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x2004000122}},
      R"(Counts all demand & prefetch RFOs)",
      R"(Counts all demand & prefetch RFOs)",
      100003,
      std::nullopt, // ScaleUnit
