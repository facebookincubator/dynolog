...
Note: Only two data-sources of L1/FB are applicable for AVX-256bit  even though the corresponding AVX load could be serviced by a deeper level in the memory hierarchy. Data source is reported for the Low-half load.)",
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x87FC007F7}},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x63BC007F7}},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x604000244}},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x87FC00091}},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x63BC00091}},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xB7, .umask = 0x01, .cmask = 0, .msr_values = {0x604000091}},
