...
*/
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Number of snoop responses received for a Local  request; Filters for a snoop response of RspSFwd.  This is returned when a remote caching agent forwards data but holds on to its current copy.  This is common for data and code reads that hit in a remote socket in E or F state.)",
      std::nullopt,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
      std::nullopt // Errata
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0x3F, .umask = 0xF},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0x40, .umask = 0xF},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0x7, .umask = 0xF},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0x8, .umask = 0xF},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0x9, .umask = 0xF},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      PmuType::uncore_imc,
      "UNC_M_CLOCKTICKS",
      EventDef::Encoding{.code = 0x00, .umask = 0x1},
