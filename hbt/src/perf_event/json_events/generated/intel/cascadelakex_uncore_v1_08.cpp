...
void addEvents(PmuDeviceManager& pmu_manager) {
  /*
    Events from cascadelakex_uncore_v1.08.json (268 events).
  ...
  */
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      PmuType::uncore_imc,
      "UNC_M_TAGCHK.HIT",
      EventDef::Encoding{.code = 0xD3, .umask = 0x1, .msr_values = {0x00}},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xD3, .umask = 0x2, .msr_values = {0x00}},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xD3, .umask = 0x4, .msr_values = {0x00}},
