...
void addEvents(PmuDeviceManager& pmu_manager) {
  /*
    Events from icelake_core_v1.05.json (321 events).
  ...
  */
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts Software prefetch requests that miss the L2 cache. This event accounts for PREFETCHNTA and PREFETCHT0/1/2 instructions.)",
      200003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
      R"(0)"));
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts Software prefetch requests that hit the L2 cache. This event accounts for PREFETCHNTA and PREFETCHT0/1/2 instructions.)",
      200003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
      R"(0)"));
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{
          .code = 0x2e, .umask = 0x01, .cmask = 0, .msr_values = {0x00}},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts number of cycles a demand request has waited due to L1D Fill Buffer (FB) unavailablability. Demand requests include cacheable/uncacheable demand load, store, lock or SW prefetch accesses.)",
      1000003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
      R"(0)"));
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{
          ...
          .cmask = 1,
          .msr_values = {0x00}},
      R"(Number of phases a demand request has waited due to L1D Fill Buffer (FB) unavailablability.)",
      R"(Counts number of phases a demand request has waited due to L1D Fill Buffer (FB) unavailablability. Demand requests include cacheable/uncacheable demand load, store, lock or SW prefetch accesses.)",
      1000003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
      R"(0)"));
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Demand Data Read transactions pending for off-core. Highly correlated.)",
      R"(Counts the number of off-core outstanding Demand Data Read transactions every cycle. A transaction is considered to be in the Off-core outstanding state between L2 cache miss and data-return to the core.)",
      1000003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
      R"(0)"));
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Cycles where data return is pending for a Demand Data Read request who miss L3 cache.)",
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts code misses in all ITLB (Instruction TLB) levels that caused a completed page walk (2M and 4M page sizes). The page walk can end with or without a fault.)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
      R"(0)"));
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts completed page walks (2M and 4M page sizes) caused by a code fetch. This implies it missed in the ITLB (Instruction TLB) and further levels of TLB. The page walk can end with or without a fault.)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
      R"(0)"));
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Number of TMA slots that were wasted due to incorrect speculation by branch mispredictions. This event accounts for operations that were issued but not retired from the specualtive path as well as the out-of-order engine recovery past a branch misprediction.)",
      10000003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
      R"(0)"));
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{
          ...
          .cmask = 1,
          .msr_values = {0x00}},
      R"(DSB-to-MITE transitions count.)",
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      "ASSISTS.FP",
      EventDef::Encoding{
          .code = 0xC1, .umask = 0x02, .cmask = 1, .msr_values = {0x00}},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(All indirect branch instructions retired (excluding RETs. TSX aborts are considered indirect branch).)",
      R"(Counts all indirect branch instructions retired (excluding RETs. TSX aborts is considered indirect branch).)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{.pebs = 1},
      R"(0)"));
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(number of branch instructions retired that were mispredicted and taken. Non PEBS)",
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts number of SSE/AVX computational 128-bit packed single precision floating-point instructions retired; some instructions will count twice as noted below.  Each count represents 4 computation operations, one for each element.  Applies to SSE* and AVX* packed single precision floating-point instructions: ADD SUB HADD HSUB SUBADD MUL DIV MIN MAX SQRT RSQRT RCP DPP FM(N)ADD/SUB.  DPP and FM(N)ADD/SUB instructions count twice as they perform 2 calculations per element.)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
      R"(0)"));
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts number of SSE/AVX computational 512-bit packed double precision floating-point instructions retired; some instructions will count twice as noted below.  Each count represents 16 computation operations, one for each element.  Applies to SSE* and AVX* packed double precision floating-point instructions: ADD SUB MUL DIV MIN MAX SQRT RSQRT14 RCP14 FM(N)ADD/SUB. FM(N)ADD/SUB instructions count twice as they perform 2 calculations per element.)",
      R"(Counts number of SSE/AVX computational 512-bit packed double precision floating-point instructions retired; some instructions will count twice as noted below.  Each count represents 16 computation operations, one for each element.  Applies to SSE* and AVX* packed double precision floating-point instructions: ADD SUB MUL DIV MIN MAX SQRT RSQRT14 RCP14 FM(N)ADD/SUB. FM(N)ADD/SUB instructions count twice as they perform 2 calculations per element.)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Number of retired PAUSE instructions.)",
      R"(Counts number of retired PAUSE instructions (that do not end up with a VMExit to the VMM; TSX aborted Instructions may be counted).)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
      R"(0)"));
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts retired load instructions that true miss the STLB.)",
      100003,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts retired store instructions that true miss the STLB.)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts all retired load instructions. This event accounts for SW prefetch instructions for loads.)",
      1000003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{.data_la = true, .pebs = 1},
      R"(0)"));
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts all retired store instructions. This event account for SW prefetch instructions and PREFETCHW instruction for stores.)",
      1000003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{
          .data_la = true, .l1_hit_indication = true, .pebs = 1},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Cycles the thread is active and superQ cannot take any more entries.)",
      R"(Counts the cycles for which the thread is active and the superQ cannot take any more entries.)",
      100003,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
      R"(0)"));
