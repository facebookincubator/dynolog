...
*/
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0x3D, .umask = 0x02},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0x3D, .umask = 0x01},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0x3D, .umask = 0x04},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      PmuType::uncore_imc,
      "UNC_M_CAS_COUNT.WR",
      EventDef::Encoding{.code = 0x04, .umask = 0x30},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0x45, .umask = 0x02},
      R"(Number of DRAM Refreshes Issued)",
      R"(Number of DRAM Refreshes Issued : Counts the number of refreshes issued.)",
      std::nullopt,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0x45, .umask = 0x04},
      R"(Number of DRAM Refreshes Issued)",
      R"(Number of DRAM Refreshes Issued : Counts the number of refreshes issued.)",
      std::nullopt,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      PmuType::uncore_irp,
      "UNC_I_FAF_FULL",
      EventDef::Encoding{.code = 0x17, .umask = 0x00},
      R"(FAF RF full)",
      R"(FAF RF full)",
      std::nullopt,
      std::nullopt, // ScaleUnit
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0x16, .umask = 0x00},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      PmuType::uncore_ubox,
      "UNC_U_CLOCKTICKS",
      EventDef::Encoding{.code = 0x00, .umask = 0x01},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      PmuType::uncore_imc,
      "UNC_M_ACT_COUNT.ALL",
      EventDef::Encoding{.code = 0x01, .umask = 0x0B},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      PmuType::uncore_imc,
      "UNC_M_PRE_COUNT.ALL",
      EventDef::Encoding{.code = 0x02, .umask = 0x1C},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0xc2, .umask = 0x03},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      EventDef::Encoding{.code = 0x12, .umask = 0x78},
