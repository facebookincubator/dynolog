...
*/
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Cache Lookups. Counts the number of times the LLC was accessed. Writeback transactions from L2 to the LLC  This includes all write transactions -- both Cacheable and UC.)",
      R"(Cache Lookups. Counts the number of times the LLC was accessed. Writeback transactions from L2 to the LLC  This includes all write transactions -- both Cacheable and UC.)",
      std::nullopt,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts the number of entries successfully inserted into the TOR that match  qualifications specified by the subevent -SF/LLC Evictions)",
      R"(Counts the number of entries successfully inserted into the TOR that match  qualifications specified by the subevent -SF/LLC Evictions)",
      std::nullopt,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts the number of entries successfully inserted into the TOR that match  qualifications specified by the subevent -PRQ)",
      R"(Counts the number of entries successfully inserted into the TOR that match  qualifications specified by the subevent -PRQ)",
      std::nullopt,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts the number of entries successfully inserted into the TOR that match  qualifications specified by the subevent -IPQ)",
      R"(Counts the number of entries successfully inserted into the TOR that match  qualifications specified by the subevent -IPQ)",
      std::nullopt,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts the number of entries successfully inserted into the TOR that match  qualifications specified by the subevent -Hit (Not a Miss))",
      R"(Counts the number of entries successfully inserted into the TOR that match  qualifications specified by the subevent -Hit (Not a Miss))",
      std::nullopt,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts the number of entries successfully inserted into the TOR that match  qualifications specified by the subevent -Miss)",
      R"(Counts the number of entries successfully inserted into the TOR that match  qualifications specified by the subevent -Miss)",
      std::nullopt,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts the number of entries successfully inserted into the TOR that match  qualifications specified by the subevent -IRQ or PRQ)",
      R"(Counts the number of entries successfully inserted into the TOR that match  qualifications specified by the subevent -IRQ or PRQ)",
      std::nullopt,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts cycles source throttling is asserted - vertical)",
      R"(Counts cycles source throttling is asserted - vertical)",
      std::nullopt,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
  ...
  pmu_manager.addEvent(std::make_shared<EventDef>(
      ...
      R"(Counts cycles source throttling is asserted - horizontal)",
      R"(Counts cycles source throttling is asserted - horizontal)",
      std::nullopt,
      std::nullopt, // ScaleUnit
      EventDef::IntelFeatures{},
